    ...
    while (true)
    {
        ...
        if (self->detected)
        {
            ...
            else
            {
                ...
                if(self->command==20)
               {
                ESP_LOGI(TAG, "Command: GET");
               }
              /* if(self->command > former_commamnd)
               {
                   ESP_LOGI(TAG, "upupup");
               }
               else if((int)self->command == former_command)
               {
                   ESP_LOGI(TAG, "BEGIN YOUR JOURNRY !");
               }
               else
               {
                   ESP_LOGI(TAG, "downdowndown");
               }
               */
