...
void AppLCD::draw_wallpaper()
{
    ...
    bool delta=(floor-former_floor)<0;
    if (NULL == pixels)
    {
    ...
    case 1:
        if (delta)
            memcpy(pixels, welcomedown1, (logo_en_240x240_lcd_width * logo_en_240x240_lcd_height) * sizeof(uint16_t));
        else
            {memcpy(pixels, welcomeup1, (logo_en_240x240_lcd_width * logo_en_240x240_lcd_height) * sizeof(uint16_t));}
        break;
    case 2:
        if (delta)
            memcpy(pixels, welcomedown2, (logo_en_240x240_lcd_width * logo_en_240x240_lcd_height) * sizeof(uint16_t));
        else
            {memcpy(pixels, welcomeup2, (logo_en_240x240_lcd_width * logo_en_240x240_lcd_height) * sizeof(uint16_t));}
        break;
    case 3:
        if (delta)
            memcpy(pixels, welcomedown3, (logo_en_240x240_lcd_width * logo_en_240x240_lcd_height) * sizeof(uint16_t));
        else
            {memcpy(pixels, welcomeup3, (logo_en_240x240_lcd_width * logo_en_240x240_lcd_height) * sizeof(uint16_t));}
        break;
    case 4:
        if (delta)
            memcpy(pixels, welcomedown4, (logo_en_240x240_lcd_width * logo_en_240x240_lcd_height) * sizeof(uint16_t));
        else
            {memcpy(pixels, welcomeup4, (logo_en_240x240_lcd_width * logo_en_240x240_lcd_height) * sizeof(uint16_t));}
        break;
    }
...
void AppLCD::update()
{
    ...
    if (this->speech->command > COMMAND_NOT_DETECTED)
    {
        ...
        if(this->speech->command >= FLOOR_ONE && this->speech->command <= FLOOR_FOUR)
        {
        floor=this->speech->command-20;
        }
    }
...
void AppLCD::run()
{
    xTaskCreatePinnedToCore((TaskFunction_t)task, TAG, 2 * 1024, this, 6, NULL, 1);
}